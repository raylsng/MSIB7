...
const authService = require('./auth.service');
    ...
    router.post('/login', async (req, res, next) => {
        ...
        const { username, password } = req.body; //mengambil data username dan password dari input user
        
        //passing data username dan passowrd dari body ke function login di auth.service
        try {
